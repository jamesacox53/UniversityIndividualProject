...
public class TestVSIDSRemoveLastElementGetNextLiteral {
    ...
    public static void main(String[] args) {
        ...
        picker.add(positiveLiterals[0]);

        picker.getNextLiteral();

        picker.add(positiveLiterals[0]);

        picker.add(negatedLiterals[2]);

        picker.add(positiveLiterals[1]);

        picker.removeIndex(2);

        picker.add(negatedLiterals[0]);
        picker.add(negatedLiterals[1]);
